...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF2 | Vlan4094 | 10.255.1.76 | Port-Channel1 |
...
| Ethernet2 | MLAG_dc1-leaf3_Ethernet2 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_dc1-spine1_Ethernet6 | - | 10.255.255.57/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_dc1-spine2_Ethernet6 | - | 10.255.255.59/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_dc1-spine4_Ethernet6 | - | 10.255.255.63/31 | default | 1500 | False | - | - |
...
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.255.1.11/32 |
| Loopback10 | DIAG_VRF_VRF-C | VRF-C | 10.255.10.12/32 |
...
| Vlan4093 |  default  |  10.255.1.77/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.1.77/31  |  -  |  -  |  -  |  -  |
| Vlan10776 |  VRF-C  |  10.255.1.77/31  |  -  |  -  |  -  |  -  |
...
| 10.255.1.76 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.255.56 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.255.58 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.255.60 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.255.62 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.1.76 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF-C | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 101 | 10.255.0.12:10101 | 10101:10101 | - | - | learned |
| 102 | 10.255.0.12:10102 | 10102:10102 | - | - | learned |
| 3401 | 10.255.0.12:13401 | 13401:13401 | - | - | learned |
| 3402 | 10.255.0.12:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF-C | 10.255.0.12:7777 | connected |
...
router bgp 65002
   ...
   neighbor 10.255.1.76 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.1.76 description dc1-leaf3_Vlan4093
   neighbor 10.255.255.56 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.56 remote-as 65100
   neighbor 10.255.255.56 description dc1-spine1_Ethernet6
   neighbor 10.255.255.58 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.58 remote-as 65100
   neighbor 10.255.255.58 description dc1-spine2_Ethernet6
   neighbor 10.255.255.60 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.60 remote-as 65100
   neighbor 10.255.255.60 description dc1-spine3_Ethernet6
   neighbor 10.255.255.62 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.62 remote-as 65100
   neighbor 10.255.255.62 description dc1-spine4_Ethernet6
   ...
   vrf VRF-C
      ...
      router-id 10.255.0.12
      neighbor 10.255.1.76 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.76 description dc1-leaf3_Vlan10776
...
```eos
!
ip address virtual source-nat vrf VRF-C address 10.255.10.12
```
