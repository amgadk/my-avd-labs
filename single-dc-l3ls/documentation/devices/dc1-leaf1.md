...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF1 | Vlan4094 | 10.255.1.73 | Port-Channel1 |
...
| Ethernet2 | MLAG_dc1-leaf2_Ethernet2 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_dc1-spine1_Ethernet3 | - | 10.255.255.33/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_dc1-spine2_Ethernet3 | - | 10.255.255.35/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_dc1-spine4_Ethernet3 | - | 10.255.255.39/31 | default | 1500 | False | - | - |
...
!
interface Ethernet2
   description MLAG_dc1-leaf2_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.255.0.9/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.255.1.9/32 |
| Loopback10 | DIAG_VRF_VRF-C | VRF-C | 10.255.10.9/32 |
...
| Vlan4093 |  default  |  10.255.1.72/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.1.72/31  |  -  |  -  |  -  |  -  |
| Vlan10776 |  VRF-C  |  10.255.1.72/31  |  -  |  -  |  -  |  -  |
...
| 10.255.1.73 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.255.32 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.255.34 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.1.73 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF-C | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 101 | 10.255.0.9:10101 | 10101:10101 | - | - | learned |
| 102 | 10.255.0.9:10102 | 10102:10102 | - | - | learned |
| 3401 | 10.255.0.9:13401 | 13401:13401 | - | - | learned |
| 3402 | 10.255.0.9:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF-C | 10.255.0.9:7777 | connected |
...
router bgp 65001
   ...
   neighbor 10.255.1.73 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.1.73 description dc1-leaf2_Vlan4093
   neighbor 10.255.255.32 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.32 remote-as 65100
   neighbor 10.255.255.32 description dc1-spine1_Ethernet3
   neighbor 10.255.255.34 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.34 remote-as 65100
   neighbor 10.255.255.34 description dc1-spine2_Ethernet3
   neighbor 10.255.255.36 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.36 remote-as 65100
   neighbor 10.255.255.36 description dc1-spine3_Ethernet3
   neighbor 10.255.255.38 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.38 remote-as 65100
   neighbor 10.255.255.38 description dc1-spine4_Ethernet3
   ...
   vrf VRF-C
      ...
      router-id 10.255.0.9
      neighbor 10.255.1.73 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.73 description dc1-leaf2_Vlan10776
...
```eos
!
ip address virtual source-nat vrf VRF-C address 10.255.10.9
```
